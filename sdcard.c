...
SD_Error SD_Init(void)
{
 u8 trans_div;
  ...
  switch(mda_or_interrupt)
  	{
	case SDCARD_MODE_DMA: trans_div=SD_DMA_CLKDIV;break;
	case SDCARD_MODE_INT: trans_div=SD_INT_CLKDIV;break;
	default: 			  trans_div=SD_POL_CLKDIV;break;
	}

  SDIO_InitStructure.SDIO_ClockDiv = trans_div; 
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_ReadBlock(u32 sector,u32 * readbuff, u16 BlockSize)
{
  SD_Error errorstatus = SD_OK;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_ReadMultiBlocks(u32 sector, u32 *readbuff, u16 BlockSize, u32 NumberOfBlocks)
{
  SD_Error errorstatus = SD_OK;
  u32 count = 0, *tempbuff = readbuff;
  u8 power = 0;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_WriteBlock(u32 sector, u32 *writebuff, u16 BlockSize)
{
  SD_Error errorstatus = SD_OK;
...
* Return         : SD_Error: SD Card Error code.
*******************************************************************************/
SD_Error SD_WriteMultiBlocks(u32 sector, u32 *writebuff, u16 BlockSize, u32 NumberOfBlocks)
{
  SD_Error errorstatus = SD_OK;
  u8  power = 0, cardstate = 0;
